...
function is designed to calculate a variety of report card scores used
by the Northern Three Report Cards. The function takes a dataframe and
...
requried. Below is a example of how to use the
[`value_to_score()`](https://add-am.github.io/RcTools/reference/value_to_score.md)
...
function has been designed to directly follow the
[`value_to_score()`](https://add-am.github.io/RcTools/reference/value_to_score.md)
function. It takes a dataframe (with scores) and appends an additional
column to the dataframe with the calculated grades.
...
[`score_to_grade()`](https://add-am.github.io/RcTools/reference/score_to_grade.md)
function. If for some reason you have multiple columns that contain
scores, multiple columns can also be provided:
...
function is designed to take a finalised dataframe from within R (such
as the one above) and save it as an excel file with formatting in the
specific style used by the Northern Three Report Cards. Below is a basic
...
![](reference/figures/README-save_n3_table-example_1.png)
...
![](reference/figures/README-save_n3_table-example_2.png)

#### extensions

The
[`save_n3_table()`](https://add-am.github.io/RcTools/reference/save_n3_table.md)
offers several other extensions for styling choices, these are as
follows:
...
![](reference/figures/README-after-rainfall-formatting.png)

Temperature:

![](reference/figures/README-after-temperature-formatting.png)

Summary statistics:

![](reference/figures/README-after-summary-statistic-formatting.png)

Presence absence:

![](reference/figures/README-after-presence-absence-formatting.png)
