...
``` r
row_splitter(df, RowCount = 1500, NameVec = NULL)
```
...
- RowCount:
  ...
  The number of rows per split dataframe. Defaults to 1500

- NameVec:

  A single dataframe name or list of dataframe names, of equal length to
  the number of dataframes provided under df. Defaults to NULL and will
  fill dataframe names with the generic "table_n"

## Value

A list of named dataframes
